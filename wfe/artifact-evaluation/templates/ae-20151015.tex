...
{\em We stongly suggest you to fill in whatever is applicable 
with some informal keywords and remove the rest. This can help
reviewers check if they have required competence}.
...
\begin{itemize}
  ...
  \item {\bf Binary: }
  \item {\bf Data set: }
  \item {\bf Run-time environment (including software dependencies): }
  \item {\bf Hardware : }
